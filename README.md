...
Key Features
Efficient Tuning: Uses Low-Rank Adaptation (LoRA) to train models with minimal VRAM.
...
Imbalance Handling: Uses Focal Loss and Class-Weighted Cross-Entropy for skewed disaster data.
